...
public class CmonkeyCluster {
    ...
    public CmonkeyCluster withDatasetIds(List<String> datasetIds) {
        this.datasetIds = datasetIds;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((("CmonkeyCluster"+" [id=")+ id)+", residual=")+ residual)+", datasetIds=")+ datasetIds)+", geneIds=")+ geneIds)+", motifs=")+ motifs)+", additionalProperties=")+ additionalProperties)+"]");
    }
