...
module Inferelator
{
	...
	*/
	funcdef find_interactions_with_inferelator(string ws_id, string series_id, string cmonkey_result_id, list<string> factors) returns(string inferelator_run_job_id) authentication required;		
};
